class Course {
    ...
    // Parameterized Constructor to initialised details
...
class OnlineCourseManagement {
    public static void main(String[] args) {
        ...
        Course course1 = new Course("Java Programming", "6 Months", 15000.0);
        Course course2 = new Course("Web Development", "4 Months", 20000.0);
        Course course3 = new Course("Artificial Intelligence", "6 Months", 30000.0);
